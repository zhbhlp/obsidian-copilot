...
**ALWAYS USE CHINESE**: All responses, explanations, comments, and communications should be in Chinese (中文). This includes:

- Code comments and JSDoc documentation
- Git commit messages
- Error messages and logging
- User-facing text and UI labels
- Technical discussions and architectural explanations
